...
* [ ] Obtenção de uso de memória (Working Set Size).
* [ ] Capacidade de finalizar (kill) processos por PID.
...
git clone [https://github.com/seu-usuario/gerenciador-cli.git](https://github.com/seu-usuario/gerenciador-cli.git)
cd gerenciador-cli
